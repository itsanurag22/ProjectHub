...
import { Button, Box, Card, CardActions, CardContent, CardHeader, Dialog, DialogActions, DialogContent, DialogContentText, DialogTitle, Divider, Grid, TextField, Typography } from '@mui/material';
                        ...
                        <CardActions >
                            <Button
                                ...
                                onClick={(e) => {
                                    ...
                                    history(`/projects/${p_id}/lists/${l_id}/cards/`)
                                }}
                            >
                                Show Cards
                            </Button>
